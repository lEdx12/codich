      ...
      <div className="auth-split__left">
        ...
        <div className="auth-split__left-content">
          ...
          <p className="auth-split__sub">
            Inicia sesión para acceder a tu panel y continuar con tus actividades en la plataforma.
          </p>
          <ul className="auth-split__features">
            <li>Acceso a tutorías especializadas</li>
            <li>Gestión de tu membresía activa</li>
            <li>Panel personalizado por rol</li>
            <li>Seguridad con JWT y bcrypt</li>
          </ul>
        </div>
      </div>
      ...
      <div className="auth-split__right">
        <div className="auth-split__form-wrap">
          <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
            ...
            <h2 style={{ fontSize: '1.4rem', fontWeight: 800, color: 'var(--color-text)' }}>Iniciar sesión</h2>
            <p style={{ color: 'var(--color-muted)', fontSize: '.875rem', marginTop: '.25rem' }}>Ingresa tus credenciales para continuar</p>
          </div>
          <LoginForm />
        </div>
      </div>
